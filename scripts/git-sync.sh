...
if git diff --cached -- . ':(exclude)scripts/git-sync.sh' | grep -qEi 'ghp_[A-Za-z0-9]{20,}|github_pat_|eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9|vck_[A-Za-z0-9]{16,}|BEGIN (RSA|OPENSSH) PRIVATE KEY|cfat_[A-Za-z0-9]{20,}|cfut_[A-Za-z0-9]{20,}'; then

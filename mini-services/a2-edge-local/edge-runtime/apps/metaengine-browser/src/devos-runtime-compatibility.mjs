...
function invalid(reason) { return zero({ state: 'INVALID_SERVER_CAPABILITY', reason }); }
...
export function evaluateDevosRuntimeCompatibility(health) {
  ...
  if (!capabilities || typeof capabilities !== 'object' || Array.isArray(capabilities)) {
    return zero({ state: 'LEGACY_SERVER_CAPABILITY_INCOMPLETE', reason: 'CAPABILITIES_MISSING' });
  }

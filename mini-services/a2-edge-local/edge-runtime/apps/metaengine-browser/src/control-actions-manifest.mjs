...
const rows = [
  ...
  ['TAB_TELEMETRY','OBSERVE','READ_ONLY','AGENT_OBSERVATION_PLANE','READ_ONLY',true,true,true],
  ['SYSTEM_TELEMETRY','OBSERVE','READ_ONLY','AGENT_OBSERVATION_PLANE','READ_ONLY',true,true,true],
  ['READ_TRANSCRIPT','OBSERVE','READ_ONLY','CDP_ACCESSIBILITY','READ_ONLY',true,true,true],
  ['TAB_CENSUS','OBSERVE','READ_ONLY','SHELL_REGISTRY','READ_ONLY',true,true,false],
  ['FLEET_STATUS','FLEET','READ_ONLY','FLEET_PROVISIONER','READ_ONLY',true,true,false],
  ...
  ['PRESS_KEY','PAGE_INPUT','MUTATING','CDP_INPUT','TAB_MUTATION',true,true,true],

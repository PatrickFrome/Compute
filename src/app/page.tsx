            ...
            {mcxOpen && (
              <div id="mechanics-body" className="space-y-3 p-3">
                ...
                <div>
                  ...
                  <div className="max-h-44 space-y-0.5 overflow-y-auto pr-1 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-zinc-700" role="list" aria-label="Реестр механик ME1–ME18">

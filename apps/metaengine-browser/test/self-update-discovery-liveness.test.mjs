...
function newerHint() {
  return { version: '0.7.0-dev.3.1', newer_than_current: true, authority_effect: false };
}
...
test('newer hint starts exact discovery singleflight without awaiting it on heartbeat-critical cycle', async () => {

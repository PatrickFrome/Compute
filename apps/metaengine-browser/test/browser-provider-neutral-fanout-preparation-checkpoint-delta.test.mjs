...
test('contract exposes compact restart-safe persistence without authority', () => {
  ...
  for (const field of [
    'payload_persisted', 'semantic_payload_persisted', 'scheduler_authority', 'dispatch_authority',
    'lease_authority', 'reservation_authority', 'effect_execution_authority', 'automatic_retry_allowed',
    'ambiguous_retry_allowed', 'authority_effect',

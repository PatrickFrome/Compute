...
const REQUIRED=[
  ...
  'rsi-exploration-graduation-certificate.mjs',
  'rsi-durable-recursive-risk-ledger.mjs',
...
test('R9 immutable roots keep verifier and effect-owner planes outside candidate mutation authority',async()=>{
  ...
  for(const source of [candidate,tournament,promotion]){
    ...
    assert.match(source,/rsi-exploration-graduation-certificate\.mjs/);
    assert.match(source,/rsi-durable-recursive-risk-ledger\.mjs/);

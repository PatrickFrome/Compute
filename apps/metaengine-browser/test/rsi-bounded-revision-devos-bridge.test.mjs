...
function phase34Fixture(label='phase34'){
  ...
  const certificateArgs={
    ...
    library_owner_identity_digest:labelDigest(label+'-phase34-library-owner-id'),
    statistical_acceptor_identity_digest:labelDigest(label+'-statistical-acceptor-id'),
    source_qualification_owner_identity_digest:labelDigest(label+'-phase34-source-qualification-owner-id'),
    least_privilege_reviewer_identity_digest:labelDigest(label+'-phase34-least-privilege-reviewer-id'),
    governance_reviewer_identity_digest:labelDigest(label+'-phase34-governance-reviewer-id'),
    benchmark_security_attestor_identity_digest:labelDigest(label+'-phase34-benchmark-security-attestor-id'),
    harness_security_attestor_identity_digest:labelDigest(label+'-phase34-harness-security-attestor-id'),

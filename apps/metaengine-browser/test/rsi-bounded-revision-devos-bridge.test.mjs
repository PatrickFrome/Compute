...
test('Phase34B runtime service closes direct-adopt bypass and routes storage append through the durable one-attempt lifecycle',async(t)=>{
  ...
  const negativeReview=await runtime.reviewDormantSkillForRetrieval({
    review_id:'phase35.runtime.dormant-review.negative-transfer',
    attempt_id:'phase34b.runtime.attempt.1',
    post_append_evaluation_epoch_digest:labelDigest('phase35-negative-epoch'),
    post_append_holdout_digest:labelDigest('phase35-negative-holdout'),
    post_append_evaluator_root_digest:labelDigest('phase35-negative-evaluator'),
    matched_control_receipt_digest:labelDigest('phase35-negative-control'),
    treatment_receipt_digest:labelDigest('phase35-negative-treatment'),
    post_append_evidence_digest:labelDigest('phase35-negative-evidence'),
    coalition_ablation_receipt_digest:labelDigest('phase35-negative-coalition'),
    marginal_contribution_receipt_digest:labelDigest('phase35-negative-marginal'),
    active_cap_policy_digest:labelDigest('phase35-negative-cap-policy'),
    retrieval_reviewer_identity_digest:labelDigest('phase35-negative-reviewer'),
    consumer_evaluator_identity_digest:labelDigest('phase35-negative-consumer-evaluator'),
    contamination_auditor_identity_digest:labelDigest('phase35-negative-contamination-auditor'),
    coalition_auditor_identity_digest:labelDigest('phase35-negative-coalition-auditor'),
    capacity_policy_owner_identity_digest:labelDigest('phase35-negative-cap-owner'),
    same_instances_pass:true,
    same_harness_pass:true,
    same_budget_pass:true,
    evaluator_integrity_pass:true,
  ...
  assert.equal(negativeReview.state,'KEEP_DORMANT_NEGATIVE_TRANSFER');
  assert.equal(negativeReview.retrieval_exposure_changed,false);
  assert.throws(()=>runtime.createSkillActivationView([fx.skill.skill_digest]),/requested_skill_not_active:DORMANT_CAP/);

  await assert.rejects(()=>runtime.reviewDormantSkillForRetrieval({
    review_id:'phase35.runtime.dormant-review.role-collapse',
    attempt_id:'phase34b.runtime.attempt.1',
    post_append_evaluation_epoch_digest:labelDigest('phase35-collapse-epoch'),
    post_append_holdout_digest:labelDigest('phase35-collapse-holdout'),
    post_append_evaluator_root_digest:labelDigest('phase35-collapse-evaluator'),
    matched_control_receipt_digest:labelDigest('phase35-collapse-control'),
    treatment_receipt_digest:labelDigest('phase35-collapse-treatment'),
    post_append_evidence_digest:labelDigest('phase35-collapse-evidence'),
    coalition_ablation_receipt_digest:labelDigest('phase35-collapse-coalition'),
    marginal_contribution_receipt_digest:labelDigest('phase35-collapse-marginal'),
    active_cap_policy_digest:labelDigest('phase35-collapse-cap-policy'),
    retrieval_reviewer_identity_digest:fx.executorIdentity,
    consumer_evaluator_identity_digest:labelDigest('phase35-collapse-consumer-evaluator'),
    contamination_auditor_identity_digest:labelDigest('phase35-collapse-contamination-auditor'),
    coalition_auditor_identity_digest:labelDigest('phase35-collapse-coalition-auditor'),
    capacity_policy_owner_identity_digest:labelDigest('phase35-collapse-cap-owner'),
    same_instances_pass:true,
    same_harness_pass:true,
    same_budget_pass:true,
    evaluator_integrity_pass:true,

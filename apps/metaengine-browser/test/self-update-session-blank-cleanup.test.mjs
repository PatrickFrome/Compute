...
test('closes only unbound ChatGPT root tabs created after restart', () => {
  const plan = planPostRestoreBlankTabCleanup({
    continuityRow: {
      tabs: [
        { url: 'https://chat.z.ai/c/current' },
        { url: 'https://chat.z.ai/c/supervisor' },
      ],
    },
    bindings: [
      { tab_id: 'tab_current' },
    ...
    currentTabs: [
      { tab_id: 'tab_current', url: 'https://chat.z.ai/c/current', selected: true },
      { tab_id: 'tab_supervisor', url: 'https://chat.z.ai/c/supervisor', selected: false },
      { tab_id: 'tab_bootstrap', url: 'https://chat.z.ai/', selected: false },
      { tab_id: 'tab_warm_1', url: 'https://chat.z.ai/', selected: false },
...
test('preserves a root ChatGPT tab that existed before update', () => {
  const plan = planPostRestoreBlankTabCleanup({
    ...
    currentTabs: [
      { tab_id: 'tab_existing_root', url: 'https://chat.z.ai/', selected: false },
      { tab_id: 'tab_supervisor', url: 'https://chat.z.ai/c/supervisor', selected: true },
      { tab_id: 'tab_new_extra', url: 'https://chat.z.ai/', selected: false },
    ],
  });
...
test('never closes non-root or bound conversation tabs', () => {
  const plan = planPostRestoreBlankTabCleanup({
    continuityRow: { tabs: [{ url: 'https://chat.z.ai/c/a' }] },
    bindings: [{ tab_id: 'tab_a' }],
    currentTabs: [
      { tab_id: 'tab_a', url: 'https://chat.z.ai/c/a', selected: true },
      { tab_id: 'tab_unknown_chat', url: 'https://chat.z.ai/c/unknown', selected: false },
      { tab_id: 'tab_legacy_chatgpt', url: 'https://chatgpt.com/', selected: false },
    ],
  });

...
const TERMINAL_CONCLUSIONS = new Set([
  'SUCCESS','FAILURE','CANCELLED','TIMED_OUT','SKIPPED','NEUTRAL','ACTION_REQUIRED','STALE','STARTUP_FAILURE',
]);
...
export function createRsiPhase33SourceQualification({
  ...
  ci_checks,
  ci_readback_manifest_digest,
  external_ci_observer_identity_digest,
  ...
  const readbackManifest = exactDigest(ci_readback_manifest_digest, 'ci_readback_manifest');
  const observerIdentity = exactDigest(external_ci_observer_identity_digest, 'ci_observer_identity');
  ...
  const core = zero({
    ...
    ci_checks: ordered,
    ci_readback_manifest_digest: readbackManifest,
    external_ci_observer_identity_digest: observerIdentity,
...
export function verifyRsiPhase33SourceQualification(row) {
  ...
  const canonical = createRsiPhase33SourceQualification({
    ...
    ci_readback_manifest_digest: row.ci_readback_manifest_digest,
    external_ci_observer_identity_digest: row.external_ci_observer_identity_digest,
    external_ci_observer: true,
    authored_by_candidate: false,
  });
...
export function createRsiAnytimeLibraryAdmissionProposal({
  ...
  const policySourceSha = exactSha(phase33_policy_source_sha, 'phase33_policy_source');
  ...
  const roots = [
    ...
    digest({phase33_policy_source_sha:policySourceSha,phase33_certificate_digest:p33.certificate.certificate_digest}),
  ];
  ...
  const core = zero({
    ...
    phase33_policy_source_sha: policySourceSha,
    ...
    consumer_model_family: p33.bundle.consumer_model_family,
    consumer_environment_family: p33.bundle.consumer_environment_family,
    consumer_context_digest: p33.bundle.consumer_context_digest,
    consumer_task_set_digest: p33.bundle.consumer_task_set_digest,
    consumer_harness_digest: p33.bundle.consumer_harness_digest,
    consumer_retrieval_profile_digest: p33.bundle.consumer_retrieval_profile_digest,
    current_consumer_plane_digest: p33.bundle.current_consumer_plane_digest,
    current_verified_library_digest: p33.bundle.current_verified_library_digest,
...
export function createRsiAnytimeLibraryAdmissionCertificate({
  ...
  if (policySource !== proposal.phase33_policy_source_sha) {
    throw new Error('rsi_phase34_predecessor_policy_source_mismatch');
  }
  const roots = [
  ...
  const core = zero({
    ...
    consumer_model_family: proposal.consumer_model_family,
    consumer_environment_family: proposal.consumer_environment_family,
    consumer_context_digest: proposal.consumer_context_digest,
    consumer_task_set_digest: proposal.consumer_task_set_digest,
    consumer_harness_digest: proposal.consumer_harness_digest,
...
export function rsiAnytimeLibraryAdmissionTrustRootSnapshot() {
  const root = {
    ...
    exact_phase33_policy_source_binding_required: true,
    exact_terminal_phase33_source_qualification_required: true,
    ci_readback_manifest_binding_required: true,
    external_ci_observer_identity_binding_required: true,

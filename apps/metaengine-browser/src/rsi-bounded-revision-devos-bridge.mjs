...
export function createRsiBoundedRevisionArtifactReceipt({
  ...
  const core={
    ...
    candidate_handoff_digest:exactDigest(handoff.handoff_digest,'candidate_handoff'),
    candidate_capsule_digest:digest(handoff.candidate_capsule),
    sandbox_plan_digest:digest(handoff.sandbox_plan),

...
function normalizeExperimentPlan(plan) {
  ...
  if (rawRevisionLimits != null) {
    ...
    revisionLimits = Object.freeze({
      ...
      artifact_provenance_policy_digest: exactDigest(rawRevisionLimits.artifact_provenance_policy_digest, 'revision_provenance_policy'),
...
export function verifyRsiIsolatedCandidateBuildPlan(plan) {
  ...
  if (revisionLimits != null) {
    ...
    for (const [field, label] of [
      ...
      ['artifact_provenance_policy_digest', 'revision_provenance_policy'],

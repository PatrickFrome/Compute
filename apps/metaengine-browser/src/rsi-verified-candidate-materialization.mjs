...
export function createRsiVerifiedCandidateMaterialization({
  ...
  const evaluatorHandoff=zeroAuthority({
    ...
    parent_sha:request.source_sha,
    mutation_surface:request.mutation_surface,
    candidate_capsule:isolateSafe(isolated.candidate_capsule),
    candidate_verification:isolateSafe(isolated.candidate_verification),
    sandbox_plan:isolateSafe(isolated.sandbox_plan),
    sandbox_plan_verification:isolateSafe(isolated.sandbox_plan_verification),

...
export class NativeSupervisorClient extends BaseNativeSupervisorClient {
  ...
  #kickIdleWork() {
    ...
    this.#idleWorkPromise = (async () => {
      ...
      // Do not hold an idle promise (and therefore a future mutating command)
      // behind an arbitrary maintenance timeout. Yield this DevOS turn and let
      // the next empty command cycle re-admit it after maintenance settles.

...
function experienceRefs(contextPlan){
  ...
  return Object.freeze(rows.map(row=>Object.freeze({
    ...
    memory_severe_harm_history:row.memory_severe_harm_history===true,
    memory_rehabilitation_evidence_satisfied:row.memory_rehabilitation_evidence_satisfied===true,
...
export function rsiContextAwareCandidateTrustRootSnapshot(){
  const root=zeroAuthority({
    ...
    memory_reliability_bound_to_context_plan:true,
    quarantined_memory_exposed_as_guidance:false,
    candidate_can_set_memory_reliability:false,
    candidate_cannot_self_rehabilitate_memory:true,
    selected_experience_must_be_candidate_guidance_allowed:true,

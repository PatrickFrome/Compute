...
export const FLEET_STATE_TARGET_REVALIDATION_VERSION = '1.0.0';

function clone(value) {
  return value == null ? value : structuredClone(value);
}

export async function persistFleetStateTargetRevalidation({ state, agent_id, observeLocalTarget, saveState } = {}) {

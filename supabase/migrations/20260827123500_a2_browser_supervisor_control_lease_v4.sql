-- A2 Browser Supervisor v4 lease split.
-- SET_SUPERVISOR_MODE belongs exclusively to the bootstrap authority lane.
-- Normal CONTROL consumers cannot lease it, preventing a race with the bootstrap FSM.
...
comment on function public.h205f22_a2_browser_supervisor_lease_control_v4(uuid,text,integer) is
  'Normal Browser Supervisor CONTROL lease; deliberately excludes SET_SUPERVISOR_MODE, which is reserved for the bootstrap authority lane.';

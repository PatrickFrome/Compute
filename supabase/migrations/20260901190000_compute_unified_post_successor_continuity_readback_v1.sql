...
begin
  ...
  elsif coalesce((v_continuity->>'authority_effect')::boolean,true) or coalesce((v_continuity->>'automatic_retry_allowed')::boolean,true) or coalesce((v_continuity->>'restart_authorized')::boolean,true) or coalesce((v_continuity->>'wake_replay_authorized')::boolean,true) or coalesce((v_continuity->>'lease_mutation_authorized')::boolean,true) then v_reason:='CONTINUITY_AUTHORITY_REJECTED';
  else

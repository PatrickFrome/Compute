-- Route the legacy normal lease RPC through the v4 control lease.
-- This is backwards-compatible for all pre-v3 actions and prevents normal
-- supervisor consumers from racing SET_SUPERVISOR_MODE away from bootstrap.
...
comment on function public.h205f22_a2_browser_supervisor_lease_v2(uuid,text,integer) is
  'Compatibility route to lease_control_v4; SET_SUPERVISOR_MODE is reserved for bootstrap authority.';

...
async function serve() {
  ...
  console.log(JSON.stringify({ schema: 'metaengine.a2-compute-browser.ready.v1', runtime: '0.3.0-dev.1', endpoint: rpc.endpoint, token_file: rpc.tokenFile, web_authority_effect: false, local_effects_present: true, debug_transport: 'native_pipe_b3', devtools_tcp_exposed: false, context_manager: 'b2_logical_context_v1', semantic_perception: 'r4_semantic_frame_v1' }));
  let stopping = false;
  const stop = async () => {
    if (stopping) return;
    stopping = true;

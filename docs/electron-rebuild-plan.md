...
### Фаза D — Supabase-контур (R53, P1, H6) — D-prep ЗАКРЫТ (R52) · исполнение миграций — оператор
...
11. ✅ **Матрица версий (K8, R52)**: живая сторона — `GET /state → capabilities.compat` (contract/daemon/ui_fallback/browser_expect/notes); человеческая проекция + история контракта — `docs/version-matrix.md`.

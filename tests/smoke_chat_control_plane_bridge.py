#!/usr/bin/env python3
"""Internal scheduler smoke test for the loopback fallback.

This intentionally runs run.mjs with A2_BRIDGE_INTERNAL=1 because the test is
exercising the internal scheduler API directly. Normal users and production
must start through secure-entry.mjs; the remote v0.5 path does not require this

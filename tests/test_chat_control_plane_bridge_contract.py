...
class ChatControlPlaneBridgeContract(unittest.TestCase):
    ...
    def test_manifest_entrypoints_exist(self):
        ...
        for path in [EXT / "background.js", EXT / "options.html", EXT / "options.js", EXT / "content.js"]:
    ...
    def test_launcher_requires_a2_credentials(self):
    ...
    def test_service_role_is_not_in_extension(self):
        combined = self.content + self.background + self.options + (EXT / "options.html").read_text()
